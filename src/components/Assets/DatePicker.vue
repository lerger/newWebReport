...
window.datePicker = (function() {
    ...
    MobileCalendar.prototype = {
        init: function(params) {
            ...
            if (this.trigger.innerHTML != null) {
                var arr = this.trigger.innerHTML.split('-');
        ...
        bindEvent: function(type) {
            ...
            function finishMobileDate(e) {
                ...
                //日期同步
                // _self.trigger.value = "2017-01-01";
                //
                ...
                document.getElementById("calendar").innerHTML = _self.trigger.value;
                if(_self.onSubmit) _self.onSubmit();
              
                //请求数据更新图表（取得选择日期,选取指标ID,）
                var currentSelectDate = _self.trigger.value;
